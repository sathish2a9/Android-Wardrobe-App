...
import com.sathishkumar.mywardrobe.Adapters.ViewPagerAdapter_S;
...
public class ShirtFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        adapter = new ViewPagerAdapter_S(context);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ((OnImageChangeListener) getActivity()).onImageChange("shirt", adapter.getCurrentItemId(viewPager.getCurrentItem()));
            }
